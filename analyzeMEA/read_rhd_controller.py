...
from analyzeMEA.intanutil.read_header import read_header
from analyzeMEA.intanutil.get_bytes_per_data_block import get_bytes_per_data_block
from analyzeMEA.intanutil.read_one_data_block import read_one_data_block
from analyzeMEA.intanutil.notch_filter import notch_filter
from analyzeMEA.intanutil.data_to_result import data_to_result
...
def read_data(filename):
    ...
    if data_present:
        ...
        if (header['version']['major'] == 1 and header['version']['minor'] >= 2) or (header['version']['major'] > 1):
            data['t_amplifier'] = np.zeros(int(num_amplifier_samples))
        else:
